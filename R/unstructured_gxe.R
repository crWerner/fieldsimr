...
#'   Alternatively, \code{T_cor_A} and \code{E_cor_A} can be specified.
...
#'   Alternatively, \code{cor_A} can be specified. By default, \code{T_cor_A = NULL}.
...
>>>>>>> 330e15de5eb3fe05cb3434e8db2b00f718347c94
