...
gy_fwt_env_means <- rnorm(n_env, gy_fwt_mean, 0.15); gy_fwt_env_means   
pht_env_means <- rnorm(n_env, pht_mean, 20); pht_env_means   

gy_fwt_env_var <- rnorm(n_env, gy_fwt_var, 0.05); gy_fwt_env_var   
pht_env_var <- rnorm(n_env, pht_var, 5); pht_env_var  
