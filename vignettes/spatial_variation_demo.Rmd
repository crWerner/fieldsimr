---
title: "Simulating plot errors and phenotypes in a plant breeding field trial"
output: html_document
vignette: >
  %\VignetteIndexEntry{Simulating plot errors and phenotypes in a plant breeding field trial}
...
```{r fig.height = 4, fig.width = 9, fig.align = "center"}
plot_effects(pheno_env1, effect = "phe.Trait1")
```
...
ggplot(pheno_env1, aes(x = phe.Trait1, fill = factor(block))) +
